<template>
    <section
        id="features-block"
        class="page-block features-block"
    >
        <div class="container">
            <scroll-anim
                :animType="'typeWriter'"
            ...
            <div class="page-block__text-block text-block">
                <p class="text-block__paragraph">
                    В этом разделе собран динамический контент, реализованный мной с помощью
                    JavaScript.
                </p>
                <p class="text-block__paragraph">
            ...
            <div class="features-block__body">
                <div class="features-block__book-pages">
                    Страниц{{ currentPages.includes('-') ? 'ы' : 'а' }} {{ currentPages }} из {{ pagesTotal }}
                </div>
                <swiper
                    :modules="modules"
                    :effect="'flip'"
                    ...
                    @observerUpdate="setCurrentPages"
                >
                    <swiper-slide
...
import TwoPages from "@/components/BookSlider/TwoPages.vue";
import SinglePage from "@/components/BookSlider/SinglePage.vue";
    ...
    methods: {
        ...
        changeMediaHandler() {
            const query = window.matchMedia(
                `(max-width: ${this.singlePageMedia}px)`
            );
            const onChange = () => {
                query.matches
        ...
        setCurrentPages(swiper) {
            ...
            if (activeSlide) {
                ...
                if (pageElems.length === 1)
                    this.currentPages =
                        pageElems[0].dataset.pageNumber.toString();
