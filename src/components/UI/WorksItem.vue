<template>
  <li class="site-item">
    ...
    <a :href="work.url" @mouseover="showFeatures = true" @mouseleave="showFeatures = false" class="site-item__body">
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            <img :src="`${work.imgDesktop}.png`" :alt="work.title" />
          </picture>
          <picture
            class="site-item__image site-item__image--transition"
            v-else-if="!isDesktop"
          ...
          >
            ...
            <img :src="`${work.imgMobile}.png`" :alt="work.title" />
          </picture>
        </transition>
        <transition name="change-show">
          <ul class="site-item__features" v-if="showFeatures">
